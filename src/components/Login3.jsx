    ...
    <div className="w-full h-screen flex">
      <div className="grid grid-cols-1 md:grid-cols-2 m-auto h-[450px] shadow-lg shadow-gray-600 sm:max-w-[900px]">
        <div className="w-full h-[450px] hidden md:block">
          <img className="w-full h-full" src={TreesImg} alt="" />
        </div>
        ...
        <div className="p-4 flex flex-col justify-around">
          <form>
            ...
            <div>
              <input className="border p-2 mr-2 max-w-[150px]" type="text" placeholder="Username" />
              <input className="border p-2 max-w-[150px]" type="text" placeholder="Password" />
            </div>
